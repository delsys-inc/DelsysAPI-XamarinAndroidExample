...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Plugin.BLE.Android.GattCallback, Plugin.BLE.Android", GattCallback.class, __md_methods);
	}
	...
	public GattCallback ()
	{
		...
		if (getClass () == GattCallback.class)
			mono.android.TypeManager.Activate ("Plugin.BLE.Android.GattCallback, Plugin.BLE.Android", "", this, new java.lang.Object[] {  });
	}
