...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Plugin.BLE.Android.Adapter+Api21BleScanCallback, Plugin.BLE.Android", Adapter_Api21BleScanCallback.class, __md_methods);
	}
	...
	public Adapter_Api21BleScanCallback ()
	{
		...
		if (getClass () == Adapter_Api21BleScanCallback.class)
			mono.android.TypeManager.Activate ("Plugin.BLE.Android.Adapter+Api21BleScanCallback, Plugin.BLE.Android", "", this, new java.lang.Object[] {  });
	}
