package md5e2420540c397e43fdf70f3ce45d9ed90;
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Plugin.BLE.Android.Adapter+Api18BleScanCallback, Plugin.BLE.Android", Adapter_Api18BleScanCallback.class, __md_methods);
	}
	...
	public Adapter_Api18BleScanCallback ()
	{
		...
		if (getClass () == Adapter_Api18BleScanCallback.class)
			mono.android.TypeManager.Activate ("Plugin.BLE.Android.Adapter+Api18BleScanCallback, Plugin.BLE.Android", "", this, new java.lang.Object[] {  });
	}
